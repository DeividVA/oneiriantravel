...
public class CharacterManager : MonoBehaviour
{
    ...
    [SerializeField]
    private CharacterMoods _alexMoods;

    [SerializeField]
    private CharacterMoods _cheeseMoods;

    [SerializeField]
    private CharacterMoods _catMoods;

    [SerializeField]
    private CharacterMoods _cruzMoods;

    [SerializeField]
    private CharacterMoods _florianMoods;

    [SerializeField]
    private CharacterMoods _oddstrongMoods;
    ...
    private CharacterMoods GetMoodSetForCharacter(CharacterName name)
    {
        switch (name)
        {
            case CharacterName.Alex:
                return _alexMoods;
            case CharacterName.Cheese:
                return _cheeseMoods;
            case CharacterName.Cat:
                return _catMoods;
            case CharacterName.Cruz:
                return _cruzMoods;
            case CharacterName.Florian:
                return _florianMoods;
            case CharacterName.Oddstrong:
                return _oddstrongMoods;
            default:
